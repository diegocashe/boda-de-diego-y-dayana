...
* @see app/Http/Controllers/InvitationController.php:50
* @route '/historia'
*/
...
* @see app/Http/Controllers/InvitationController.php:69
* @route '/asistencia'
*/
...
* @see app/Http/Controllers/InvitationController.php:80
...
* @see app/Http/Controllers/InvitationController.php:126
* @route '/asistencia/{invitation}'
*/
...
* @see app/Http/Controllers/InvitationController.php:113
...
* @see app/Http/Controllers/InvitationController.php:158
* @route '/detalles'
*/
...
const InvitationController = { home, story, rsvp, rsvpShow, rsvpStore, ogImage, details }
